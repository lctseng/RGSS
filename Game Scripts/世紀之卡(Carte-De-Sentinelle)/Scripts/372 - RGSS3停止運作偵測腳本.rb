...
GOBJ_NOTIFY_CRITICAL = true # when true, displays information regarding critical 
...
# VX ACE NOTE - use at your own risk
...
cl.class_eval {
  alias gobj_initialize initialize unless $@
  def initialize(*args)
    gobj_initialize(*args)
    #puts "產生物件：#{self}"
    #puts "來自："
    #puts caller[0..100]
  end
